...
2. Open Fle Station in DSM. \
    ...
    - <img src="./images/synology/corefile_text.png" alt=“” width="30%" height="25%">
...
3. Open the Docker management console (select it from installed packages in the Package Center) and go to the `Registry` tab.  
     ...
     - <img src="./images/synology/docker_image.png" alt=“” width="30%" height="25%">
...
4. Double click the coredns-omada Image to create a Docker Container
    ...
    - <img src="./images/synology/network_pane.png" alt=“” width="30%" height="25%">
    - On the General Settings pane
        ...
        - <img src="./images/synology/general_settings_pane.png" alt=“” width="30%" height="25%">
        - Click the Advanced Settings button
            ...
            - <img src="./images/synology/advanced_settings_env_vars.png" alt=“” width="30%" height="25%">
            ...
            - <img src="./images/synology/advanced_settings_exec_command.png" alt=“” width="30%" height="25%">
    ...
    - <img src="./images/synology/port_settings_pane.png" alt=“” width="30%" height="25%">
